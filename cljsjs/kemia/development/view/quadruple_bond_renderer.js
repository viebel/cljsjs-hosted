...
kemia.view.QuadrupleBondRenderer.prototype.render = function(bond,
	...
	var transleft1 = new kemia.graphics.AffineTransform(1, 0, 0, 1, Math
			.cos(angle_left)
			* bondWidth / 3, Math.sin(angle_left) * bondWidth / 3);

	var transright1 = new kemia.graphics.AffineTransform(1, 0, 0, 1, Math
			.cos(angle_right)
			* bondWidth / 3, Math.sin(angle_right) * bondWidth / 3);
	var transleft2 = new kemia.graphics.AffineTransform(1, 0, 0, 1, Math
			.cos(angle_left)
			* bondWidth, Math.sin(angle_left) * bondWidth);

	var transright2 = new kemia.graphics.AffineTransform(1, 0, 0, 1, Math
			.cos(angle_right)
